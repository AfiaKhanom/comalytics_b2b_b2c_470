...
namespace NopStation.Plugin.B2B.ERPIntegrationCore
{
    public static class ERPIntegrationCoreDefaults
    {
        ...
        public static CacheKey ErpProductPricingCommonCacheKey => new("ErpProductPricingCommonCacheKey.{0}-{1}-{2}-{3}", ErpProductPricingCommonPrefix);
        public static string ErpProductPricingCommonPrefix => "ErpProductPricingCommonCacheKey";
