...
public class ERPIntegrationCorePlugin : BasePlugin, IMiscPlugin, IAdminMenuPlugin, INopStationPlugin
{
    ...
    public List<KeyValuePair<string, string>> PluginResouces()
    {
        ...
        {
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.ErpAccount.Select", "Select"),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPlugin", "ERP Integration Plugin"),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPlugin.Hint", "Select an ERP Integration Plugin from these System Names."),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Title", "ERP Integration Core Settings"),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.BlockTitle.Settings", "Settings"),
            new ("Plugins.Misc.NopStation.ERPIntegrationCore.Configuration.Updated", "ERPIntegrationCore settings has been updated successfully."),
        };
    }
