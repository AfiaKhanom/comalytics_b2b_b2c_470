...
public class B2BStockService : IB2BStockService
{
    ...
    public B2BStockService(ISqlIntegrationService sqlIntegrationService,
        SqlClient sqlClient,
    ...
    public async Task<ErpResponseData<IList<ErpStockDataModel>>> GetStockFromErpAsync(ErpGetRequestModel erpRequest)
    {
        ...
        try
        {
            ...
            var erpStockResponseData = JsonConvert.DeserializeObject<List<ErpStockSqlResponseModel>>(response.Data.ToString());
