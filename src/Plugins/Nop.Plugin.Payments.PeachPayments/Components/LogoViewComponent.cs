...
[ViewComponent(Name = PeachPaymentsDefaults.LOGO_VIEW_COMPONENT_NAME)]
...
public  class LogoViewComponent : NopViewComponent
{
    ...
    public async Task<IViewComponentResult> InvokeAsync(string widgetZone, object additionalData)
    {
        ...
        var script = widgetZone.Equals(PublicWidgetZones.HeaderLinksBefore) && _settings.DisplayLogoInHeaderLinks
            ...
            : (widgetZone.Equals(PublicWidgetZones.Footer) && _settings.DisplayLogoInFooter ? _settings.LogoInFooter : null);
