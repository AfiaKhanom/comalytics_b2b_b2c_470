...
public partial class ErpAccountSettingModelValidator : BaseNopValidator<ErpAccountSettingModel>
{
    public ErpAccountSettingModelValidator(ILocalizationService localizationService, ID365Service d365Service)
    {
