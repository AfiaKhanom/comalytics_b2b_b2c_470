...
public partial class ErpCreateAccountSettingsModelValidator : BaseNopValidator<ErpCreateAccountSettingsModel>
{
    public ErpCreateAccountSettingsModelValidator(ILocalizationService localizationService, ID365Service d365Service)
    {
