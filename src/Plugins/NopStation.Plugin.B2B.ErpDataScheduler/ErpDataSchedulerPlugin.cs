...
public class ErpDataSchedulerPlugin : BasePlugin, IAdminMenuPlugin, IMiscPlugin, INopStationPlugin
{
    ...
    public List<KeyValuePair<string, string>> PluginResouces()
    {
        return new List<KeyValuePair<string, string>>
        {
            ...
            new ("Plugin.Misc.NopStation.ErpDataScheduler.Admin.Configure.Block.SyncFromDate", "Date Selection to Sync from"),
            ...
            new ("Plugin.Misc.NopStation.ErpDataScheduler.Admin.Configure.Fields.EnalbeSendingEmailNotificationOnSyncError", "Enable sending email notification on sync error"),
            new ("Plugin.Misc.NopStation.ErpDataScheduler.Admin.Configure.Fields.EnalbeSendingEmailNotificationOnSyncError.Hint", "Enable sending email notification on sync error, on default, a mail will be sent to store owner"),
            new ("Plugin.Misc.NopStation.ErpDataScheduler.Admin.Configure.Fields.EmailAddresses", "Email Addresses"),
            new ("Plugin.Misc.NopStation.ErpDataScheduler.Admin.Configure.Fields.EmailAddresses.Hint", "Configure the email addresses (semi-colon separated) to which the sync related notification will be sent"),
            new ("Plugin.Misc.NopStation.ErpDataScheduler.Admin.Configure.Fields.Error.EmailEmptyError", "Email address cannot be empty"),
            new ("Plugin.Misc.NopStation.ErpDataScheduler.Admin.Configure.Block.SyncNotification", "Sync Notification"),
