...
public class QuartzSchemaMigration : FluentMigrator.Migration
{
    ...
    public override void Down()
    {
        ...
        Delete.ForeignKey("FK_QRTZ_TRIGGERS_QRTZ_JOB_DETAILS").OnTable("QRTZ_TRIGGERS");
        Delete.ForeignKey("FK_QRTZ_CRON_TRIGGERS_QRTZ_TRIGGERS").OnTable("QRTZ_CRON_TRIGGERS");
        Delete.ForeignKey("FK_QRTZ_SIMPLE_TRIGGERS_QRTZ_TRIGGERS").OnTable("QRTZ_SIMPLE_TRIGGERS");
        Delete.ForeignKey("FK_QRTZ_SIMPROP_TRIGGERS_QRTZ_TRIGGERS").OnTable("QRTZ_SIMPROP_TRIGGERS");

        // Drop indexes
        Delete.Index("IDX_QRTZ_T_G_J").OnTable("QRTZ_TRIGGERS");
        Delete.Index("IDX_QRTZ_T_C").OnTable("QRTZ_TRIGGERS");
        Delete.Index("IDX_QRTZ_T_N_G_STATE").OnTable("QRTZ_TRIGGERS");
        Delete.Index("IDX_QRTZ_T_STATE").OnTable("QRTZ_TRIGGERS");
        Delete.Index("IDX_QRTZ_T_N_STATE").OnTable("QRTZ_TRIGGERS");
        Delete.Index("IDX_QRTZ_T_NEXT_FIRE_TIME").OnTable("QRTZ_TRIGGERS");
        Delete.Index("IDX_QRTZ_T_NFT_ST").OnTable("QRTZ_TRIGGERS");
        Delete.Index("IDX_QRTZ_T_NFT_ST_MISFIRE").OnTable("QRTZ_TRIGGERS");
        Delete.Index("IDX_QRTZ_T_NFT_ST_MISFIRE_GRP").OnTable("QRTZ_TRIGGERS");
        Delete.Index("IDX_QRTZ_FT_INST_JOB_REQ_RCVRY").OnTable("QRTZ_FIRED_TRIGGERS");
        Delete.Index("IDX_QRTZ_FT_G_J").OnTable("QRTZ_FIRED_TRIGGERS");
        Delete.Index("IDX_QRTZ_FT_G_T").OnTable("QRTZ_FIRED_TRIGGERS");
