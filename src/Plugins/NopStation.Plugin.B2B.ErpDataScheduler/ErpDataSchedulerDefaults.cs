...
public static class ErpDataSchedulerDefaults
{
    ...
    /// </summary>
    public static int ApproxSyncTaskTimeOutPeriodForMemoryLockRun => 3600;
    ...
    /// <summary>
    /// Gets a type of the erp account credit synchronization schedule task
    /// </summary>
    public static string ErpAccountCreditSyncTask => "NopStation.Plugin.B2B.ErpDataScheduler.Services.SyncTaskServices.ErpAccountCreditSyncTask";

    /// <summary>
    /// Gets a name of the erp account credit synchronization schedule task name
    /// </summary>
