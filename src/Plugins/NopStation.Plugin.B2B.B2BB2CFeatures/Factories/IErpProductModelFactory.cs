...
public interface IErpProductModelFactory
{
    ...
    Task<IList<ErpProductDataModel>> PrepareErpProductDataListModelAsync(List<string> productIds, ErpAccount erpAccount, B2BB2CFeaturesSettings b2BB2CFeaturesSettings);
