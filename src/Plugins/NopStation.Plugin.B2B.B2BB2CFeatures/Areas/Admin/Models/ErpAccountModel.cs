...
{
    public record ErpAccountModel : BaseNopEntityModel
    {
        #region Ctor

        public ErpAccountModel()
        {
            BillingAddress = new AddressModel();
            ErpAccountStatusTypes = new List<SelectListItem>();
            AvailableErpSalesOrgs = new List<SelectListItem>();
            AvailableB2BPriceGroupCodes = new List<SelectListItem>();
            ErpNopUserSearchModel = new ErpNopUserSearchModel();
            ErpShipToAddressSearchModel = new ErpShipToAddressSearchModel();
        }
        ...
        [NopResourceDisplayName("Plugin.Misc.NopStation.ERPIntegrationCore.ErpAccount.Field.PercentageOfStockAllowed")]
        ...
        public IList<SelectListItem> AvailableB2BPriceGroupCodes { get; set; }
        public ErpNopUserSearchModel ErpNopUserSearchModel { get; set; }
        public ErpShipToAddressSearchModel ErpShipToAddressSearchModel { get; set; }
